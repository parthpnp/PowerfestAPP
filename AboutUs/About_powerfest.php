...
<div class="z-depth-1 content-wrap-shadow" style="height:auto;">
	...
	<h5 align="center">Powerfest 2016 </h5>
		...
		<div align="justify">
		<p style="color:black;">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;A good idea with proper work has the power to change the world. Our society and nation needs a newly stricken idea, a belief and a vision to spark a revolution. Powerfest is introduced with an objective to utilize the technical skills in the best possible way for shaping a better future for society and nation.


<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Gujarat Power Engineering and Research Institute (GPERI) is organizing state level technical festival Powerfest - "Actions Cultivate the Intellect" for the first time which is scheduled on 18th – 19th February, 2016. Powerfest comprises of 25+ competitive technical eventsconsolidating Civil,Computer, Electrical and Mechanical branches of engineering.
</p>		</div>
</div>
...
<!--<center>
  ...
  <br>
	...
	<div class="hidden-md hidden-lg hidden-sm">
		...
		<a class="waves-effect waves-light btn" href="resources/Robowars2015-16.pdf" target="_blank">PROBLEM STATEMENT</a>
		<br>
		<a class="waves-effect waves-light btn" href="robowars/register.php" target="_blank">REGISTER</a>
